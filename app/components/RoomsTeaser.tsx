...
const teaserRooms = [
  {
    img: "/img/interior-2.jpg", label: "Барнхаусы", sub: "для двоих", count: "8 домов",
    meta: [["Площадь", "~ 30 м²"], ["Гости", "2"], ["Особое", "терраса"]] as const,
    price: "от 18 200 ₽",
  },
  {
    img: "/img/interior-1.jpeg", label: "Большие барнхаусы", sub: "легенды русской науки", count: "4 дома",
    meta: [["Площадь", "~ 70 м²"], ["Гости", "до 4"], ["Особое", "3 спальни"]] as const,
    price: "от 32 400 ₽",
  },
  {
    img: "/img/interior-2.jpg", label: "Таунхаусы", sub: "литература и гуманизм", count: "6 домов",
    meta: [["Площадь", "~ 92 м²"], ["Гости", "до 6"], ["Особое", "кабинет"]] as const,
    price: "от 38 600 ₽",
  },
];
    ...
    <article id="rooms" style={{ padding: "36px 0 28px", borderBottom: "1px solid var(--ink)" }}>
      <div style={{
        ...
        <h2 style={{
          ...
          Шестнадцать домов.<br/>
          <span style={{ fontStyle: "italic", fontWeight: 500 }}>Три</span> формата.
        </h2>
        <p style={{
          ...
          Каждый дом назван именем русского лауреата или классика. Цены указаны за сутки в низкий сезон; в праздничные дни действуют особые условия.
        </p>
      </div>
